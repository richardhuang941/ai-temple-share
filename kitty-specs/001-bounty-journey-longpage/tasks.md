...
| T011 | 构建 Journey 区的阶段脉冲与状态可视化基础组件 | WP03 |  | [D] |
| T012 | 构建单任务的里程碑卡片组件 | WP03 |  | [D] |
...
| T021 | 组合 `App` 与入口文件，串联四个主区块 | WP05 |  | [D] |
| T022 | 打通整页时间轴、锚点导航与分享态强调逻辑 | WP05 |  | [D] |
| T023 | 添加整页集成测试，覆盖主区块、任务顺序与关键文案 | WP05 |  | [D] |
| T024 | 运行构建/测试验证并修复最终验收问题 | WP05 |  | [D] |
...
Included subtasks:
- [x] T021 组合 `App` 与入口文件，串联四个主区块 (WP05)
- [x] T022 打通整页时间轴、锚点导航与分享态强调逻辑 (WP05)
- [x] T023 添加整页集成测试，覆盖主区块、任务顺序与关键文案 (WP05)
- [x] T024 运行构建/测试验证并修复最终验收问题 (WP05)
