...
const shareSummaryByLocale: Record<LocaleCode, ShareSummary> = {
  zh: {
    ...
    scoreSummary: "Agent 打分已经锁在高匹配区间。",
    ...
    qualificationNote:
      "Task 1 到 Task 3 在主线路径里推进；Task 4 继续进入 SHIT Skills 原生动作；Task 5 只是可选加分项。"
  },
  en: {
    title: "Share your result",
    titleTemplate: "{headline} has resonated and joined {faction}.",
    scoreSummary: "The Agent score is already locked in the high-match zone.",
    ...
    supportingFacts: [
      ...
      "The AIBOUNTY reward rhythm is now visible",
      "The Telegram check-in line is ready"
    ],
    qualificationNote:
      "Task 1 to Task 3 run on the mainline path. Task 4 continues in the native SHIT Skills flow. Task 5 is optional only."
  }
};
